...
const transporter = nodemailer.createTransport({
    ...
    auth: {
        ...
        pass: 'ваш_пароль_приложения' // замените на реальный пароль приложения
    }
});
...
function initDatabase() {
    db.serialize(() => {
        ...
        // Таблица участников команды (теперь храним только имя, без связи с users)
...
// Получение команды по ID (с участниками)
...
// Добавление игрока в команду (без проверки существования в users)
...
// Удаление матча (только создатель)
